---
title: "Model2 Regressions Initial"
author: "Mike Wise"
date: "18 Mar 2017"
...
if (m=="model2"){
  df2 <- getResults2()
  kdf <- df2[,c("idx","title","model","formula","chgDate","chgVal","chgCoef.fit","chgCoef.smry","chgStd.smry","chgTval.smry","chgPval.smry")]
  kdf <- kdf %>% mutate(s=starval(chgPval.smry))
  kable(kdf,format="html",padding=5)
}
```
