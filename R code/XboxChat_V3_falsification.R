...
Gamesdata <- subset(newdata_USA,Subject == "TS - Xbox Games & Apps")
newdata <- Gamesdata 
...
plot(daily$date_formatted, daily$ChatsInBlock,  main = "TS - Xbox Games & Apps", xlab = "Date", ylab = "Chat Initiations", pch=19)
