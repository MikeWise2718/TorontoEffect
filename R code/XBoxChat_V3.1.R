...
mydata <- read.csv("chat_volume_duration_features-2015-2017.csv")
colnames(mydata)
...
newdata %>%   group_by(Subject) %>%   summarise_each (funs(mean, min, max, sd) , mean_Chats_per_hour = ChatsInBlock)
